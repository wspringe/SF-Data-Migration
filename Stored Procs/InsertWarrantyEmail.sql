...
AS
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Warranty_Home_Owner__cXref', 'Warranty_Home_Owner__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'WorkOrderXref', 'Work_Order__c'
