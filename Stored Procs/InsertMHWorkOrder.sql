...
AS
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'WorkOrderXref', 'WorkOrder__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Cost_Code__cXref', 'Cost_Code__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Warranty_Appointment__cXref', 'Warranty_Repair__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Warranty_Vendor__cXref', 'Warranty_Vendor__c'
