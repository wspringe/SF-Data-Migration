...
GO
CREATE PROCEDURE [dbo].[Insert_CommunitySheetFreeway] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Freeway__c', @targetLinkedServerName, @sourceLinkedServerName
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Freeway__cXref', 'Freeway__c'
