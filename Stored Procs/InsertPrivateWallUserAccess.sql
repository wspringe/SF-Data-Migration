...
GO
CREATE PROCEDURE [dbo].[Insert_PrivateWallUserAccess] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'CC_Private_Chatter_Wall__c', @targetLinkedServerName, @sourceLinkedServerName
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'CC_Private_Chatter_Wall__cXref', 'Home_Buyers_Portal_Private_Chatter_Wall__c'
