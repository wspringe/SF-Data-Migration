...
GO
CREATE PROCEDURE [dbo].[Create_Opportunity_Cross_Reference_Table] (
...
AS
  ...
  BEGIN
	  ...
	  EXEC SF_Replicate @sourceLinkedServerName, 'Opportunity__c' , 'pkchunk'
  ...
  BEGIN
	  ...
	  EXEC SF_Replicate @targetLinkedServerName, @objectName, 'pkchunk'
