...
GO
ALTER PROCEDURE [dbo].[Insert_AreaPlanMasterLink] (
  @objectName VARCHAR(50)

  /*
    This stored procedure is used for inserting and upserting data for the Area_Plan_Master_Link object.

    Circular definition fields: None.

    Need: Communities, Community plan master for page layout (metadata)
