...
GO
CREATE PROCEDURE [dbo].[Insert_CommunitySheetNearbyLocation] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Nearby_Location__c', @targetLinkedServerName, @sourceLinkedServerName
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Nearby_Location__cXref', 'Nearby_Location__c'
