...
GO
CREATE PROCEDURE [dbo].[Insert_ContractManagementAttachment] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Contract_Management_Tracker__c', @targetLinkedServerName, @sourceLinkedServerName


  -- Update stage table with new Ids for Region lookup
  RAISERROR('Replacing Ids from target org...', 0, 1) WITH NOWAIT
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Contract_Management_Tracker__cXref', 'Contract_Management_Tracker__c'
