...
GO
ALTER PROCEDURE [dbo].[Insert_CastIronLastRunTime] (
  @objectName VARCHAR(50)

  /*
    This stored procedure is used for inserting and upserting data for the CastIronLastRunTime object.
...
AS
  ...
  SET @SQL = 'DECLARE @ret_code Int' +
        ...
        BEGIN' +
          ...
          char(10) + 'EXEC @ret_code = SF_BulkOps ''Upsert'', ''SFDC_Target'', ''' + @stagingTable +''', ''Orchestration_Name__c''' +
