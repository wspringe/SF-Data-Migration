...
GO
ALTER PROCEDURE [dbo].[Insert_CommunityPlanMasterFeature] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Feature__c', @targetLinkedServerName, @sourceLinkedServerName
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Feature__cXref', 'Feature__c'
