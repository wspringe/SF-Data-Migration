...
GO
ALTER PROCEDURE [dbo].[Insert_UserDefinedCodeValue] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'User_Defined_Code_Types__c', @targetLinkedServerName, @sourceLinkedServerName


  -- Update stage table with new Ids for Region lookup
  RAISERROR('Replacing Ids from target org...', 0, 1) WITH NOWAIT
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'User_Defined_Code_Types__cXref', 'User_Defined_Code_Type__c'
