...
GO
CREATE PROCEDURE [dbo].[Insert_UserDefinedCodeTypes] (
  @objectName VARCHAR(50)

  /*
    This stored procedure is used for inserting and upserting data for the User_Defined_Code_Types__c object.
