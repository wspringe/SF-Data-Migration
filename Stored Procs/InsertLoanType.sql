...
GO
ALTER PROCEDURE [dbo].[Insert_LoanType] (
  @objectName VARCHAR(50),
  @targetLinkedServerName VARCHAR(50),
  @sourceLinkedServerName VARCHAR(50)

  /*
    This stored procedure is used for inserting and upserting data for the Loan_Type object.
...
AS
  ...
  RAISERROR('Setting me as owner of records...', 0 ,1) WITH NOWAIT
  SET @SQL = 'UPDATE ' + @stagingTable + ' 
             SET OwnerId = ''0054D000000nyn7QAA'''
  EXEC sp_executesql @SQL
