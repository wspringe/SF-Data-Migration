...
GO
CREATE PROCEDURE [dbo].[Insert_TPSAttachment] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Trade_Partner_Setup__c', @targetLinkedServerName, @sourceLinkedServerName


  -- Update stage table with new Ids for Region lookup
  RAISERROR('Replacing Ids from target org...', 0, 1) WITH NOWAIT
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Trade_Partner_Setup__cXref', 'Trade_Partner_Setup__c'
