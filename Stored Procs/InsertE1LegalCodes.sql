...
GO
ALTER PROCEDURE [dbo].[Insert_E1LegalCodes] (
  @objectName VARCHAR(50)

  /*
    This stored procedure is used for inserting and upserting data for the E1_Legal_Codes object.
...
AS
  ...
  SET @SQL = 'DECLARE @ret_code Int' +
        ...
        BEGIN' +
          ...
          char(10) + 'EXEC @ret_code = SF_BulkOps ''Upsert'', ''SFDC_Target'', ''' + @stagingTable +''', ''Legal_Code__c''' +
