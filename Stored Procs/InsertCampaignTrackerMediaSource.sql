...
GO
CREATE PROCEDURE [dbo].[Insert_CampaignTrackerMediaSource] (
...
AS
  ...
  EXEC Create_Cross_Reference_Table 'Campaign_Tracker__c', 'Name', @targetLinkedServerName, @sourceLinkedServerName
