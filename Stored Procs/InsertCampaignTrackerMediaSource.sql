...
GO
ALTER PROCEDURE [dbo].[Insert_CampaignTrackerMediaSource] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Campaign_Tracker__c', @targetLinkedServerName, @sourceLinkedServerName

   -- Update stage table with new UserIds for Owner'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Campaign_Tracker__cxRef', 'Campaign_Tracker__c'
