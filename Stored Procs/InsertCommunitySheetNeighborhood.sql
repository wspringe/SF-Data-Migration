...
GO
CREATE PROCEDURE [dbo].[Insert_CommunitySheetNeighborhood] (
...
AS
  ...
  EXEC Create_Id_Based_Cross_Reference_Table 'Neighborhood__c', @targetLinkedServerName, @sourceLinkedServerName
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Neighborhood__cXref', 'Neighborhood__c'
