...
GO
CREATE PROCEDURE [dbo].[Insert_BrontoCampaignResponse] (
...
AS
  ...
  EXEC Create_Cross_Reference_Table 'Bronto_Messages__c', 'Name', @targetLinkedServerName, @sourceLinkedServerName
    EXEC Create_Cross_Reference_Table 'Bronto_Deliveries__c', 'Name', @targetLinkedServerName, @sourceLinkedServerName

   -- Update stage table with new UserIds for Owner'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'UserXRef', 'OwnerId'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Bronto_Deliveries__cxRef', 'Bronto_Delivery__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'Bronto_Deliveries__cxRef', 'Bronto_Campaign__c'
