...
GO
CREATE PROCEDURE [dbo].[Insert_BudgetTracker] (
...
AS
  ...
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'UserXref', 'CPA__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'UserXref', 'Purchasing_Agent__c'
  EXEC Replace_NewIds_With_OldIds @stagingTable, 'AccountXref', 'Vendor__c'
